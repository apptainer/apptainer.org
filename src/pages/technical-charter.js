...
const TechnicalCharter = () => (
        <Layout>
        <Seo title="Technical Charter" />
        <div>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div className="max-w-xl mb-5 md:mx-auto lg:max-w-2xl">
                    ...
                    <div className="text-base text-black prose">
                        <p>This Charter sets forth the responsibilities and procedures for technical contribution to, and oversight of, the Apptainer open source project, which has been established as Apptainer a Series of LF Projects, LLC (the “Project”). LF Projects, LLC (“LF Projects”) is a Delaware series limited liability company. All contributors (including committers, maintainers, and other technical positions) and other participants in the Project (collectively, “Collaborators”) must comply with the terms of this Charter.</p>

                        <h2>1. Mission and Scope of the Project</h2>
                        <ol type="a">
                            <li>The mission of the Project is to maintain and enhance the source code of the Apptainer open source container platform.</li>
                        ...
                        <h2>2. Technical Steering Committee</h2>
                        <ol type="a">
                            ...
                            <li>Responsibilities: The TSC will be responsible for all aspects of oversight relating to the Project, which may include:
                                <ol type="i">
                                    ...
                                    <li>establishing community norms, workflows, issuing releases, and security reporting policies;</li>
                        ...
                        <ol type="a">
                            ...
                            <li>In the event a vote cannot be resolved by the TSC, any voting members of the TSC may refer the matter to the Series Manager for assistance in reaching a resolution.</li>
                        </ol>
                        ...
                        <ol type="a">
                            ...
                            <li>The TSC may adopt a code of conduct ("CoC") for the Project, which is subject to approval by the Series Manager. In the event that a Project-specific CoC has not been approved, the LF Projects Code of Conduct listed at https://lfprojects.org/policies will apply for all Collaborators in the Project.</li>
                        ...
                        <ol type="a">
                            <li>LF Projects will hold title and all trade or service marks used by the Project ("Project Trademarks"), whether bases on common law or registered rights. Project Trademarks will be transferred and assigned to LF Projects to hold on behalf of the Project. Any use of any Project Trademarks by Collaborators in the Project will be in accordance with the license from LF Projects and inure to the benefit of LF Projects.</li>
                        ...
                        <ol type="a">
                            <li>Collaborators acknowledge that the copyright in all new contributions will be retained by the copyright holder as independent works of authorship and that no contributor or copyright holder will be required to assign copyright to the Project.</li>
                            <li>
                                Except as described in Section 7.c., all contributions to the Project are subject to the following:
                                <ol type="i">
                                    <li>All new inbound code contributions to the Project must be made using the 3-clause BSD License (the "Project License").</li>
                                    ...
                                    <li>To the extent a contributino includes or consists of data, any rights in such data shall be made available under the CDLA-Permissive 2.0 License, available at https://cdla.dev/permissive-2.0.</li>
...
export default TechnicalCharter